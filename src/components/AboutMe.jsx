...
const AboutMe = () => {
    ...
    return (
        <div id='aboutMe' className='flex items-center justify-center my-10'>
            <div className='text-center w-5/6 md:w-4/6 caja md:p-8'>
                ...
                <p className='text-lg sm:text-2xl p-3 text-center my-8 mx-auto w-auto md:w-3/4'>{data.basics.summary}</p>
                <a
